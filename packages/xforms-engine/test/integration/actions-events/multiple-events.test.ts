...
import multipleEvents from '../../scenario/fixtures/test-javarosa/resources/multiple-events.xml?raw';
import invalidEvents from '../../scenario/fixtures/test-javarosa/resources/invalid-events.xml?raw';
...
describe('multiple events', () => {
  describe('nested first load event', () => {
    ...
    it('sets the value when nested', async () => {
      const scenario = await Scenario.init(multipleEvents);
  ...
  describe('invalid event names', () => {
    ...
    it('throws an exception', async () => {
      const init = async () => {
        await Scenario.init(invalidEvents);
      };
