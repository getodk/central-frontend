...
// Initialize a tree-sitter parser instance, with the
// @odk-web-forms/tree-sitter-xpath language loaded. This is used in the test
// environment, and roughly serves as a reference implementation for how a
// similarly configured project will need to be initialized downstream.
