...
} from '../src/adapter/defaults.ts';
import { DEFAULT_DOM_ADAPTER, DEFAULT_DOM_PROVIDER } from '../src/adapter/defaults.ts';
import type { DefaultEvaluatorOptions } from '../src/evaluator/DefaultEvaluator.ts';
import type { XFormsElementRepresentation } from '../src/xforms/XFormsElementRepresentation.ts';
import type {
	XFormsItextTranslationElement,
	XFormsItextTranslationsState,
} from '../src/xforms/XFormsItextTranslations.ts';
import type { XFormsSecondaryInstanceElement } from '../src/xforms/XFormsSecondaryInstances.ts';
import type { XFormsXPathRootNode } from '../src/xforms/XFormsXPathEvaluator.ts';
...
interface TestXFormsXPathEvaluatorOptions extends DefaultEvaluatorOptions {
 ...
 */
export class TestXFormsXPathEvaluator extends XFormsXPathEvaluator<DefaultDOMAdapterNode> {
	/**
	...
	constructor(options: TestXFormsXPathEvaluatorOptions) {
		// prettier-ignore
		const rootNode = (
			options.rootNode ??
			null
