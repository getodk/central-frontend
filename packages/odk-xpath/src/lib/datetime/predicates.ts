...
import { ISO_DATE_LIKE_PATTERN, ISO_DATE_OR_DATE_TIME_LIKE_PATTERN, ISO_DATE_TIME_LIKE_PATTERN, ISO_TIME_LIKE_PATTERN } from './constants.ts';
...
export const isISODateOrDateTimeLike = (value: string) => ISO_DATE_OR_DATE_TIME_LIKE_PATTERN.test(value);
