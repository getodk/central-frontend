...
describe('Reiterable', () => {
  ...
  describe('reiterating', () => {
    ...
    it.each(cases)('is repeatedly iterable over the same $sourceType values', ({
      source,
    }) => {
      const reiterable = Reiterable.from(source());
    ...
    it.each(cases)('repeatedly produces an iterator of the same $sourceType values', ({
      source,
    }) => {
      const reiterable = Reiterable.from(source());
    ...
    describe.each(cases)('collection-like APIs with a $sourceType source', ({ source }) => {
      ...
      it.each(beforeCases)('gets the entries $beforeDescription', ({
        before,
      }) => {
        const reiterable = Reiterable.from(source());
      ...
      it.each(beforeCases)('gets the keys $beforeDescription', ({
        before,
      }) => {
        const reiterable = Reiterable.from(source());
      ...
      it.each(beforeCases)('gets the values $beforeDescription', ({
        before,
      }) => {
        const reiterable = Reiterable.from(source());
    ...
    describe.each(cases)('predicates with a $sourceType source', ({ source }) => {
      ...
      it.each(someCases)('determines that a predicate checking for some value of $predicateExpected returns $expected', ({
        predicateExpected,
        expected,
      }) => {
        const reiterable = Reiterable.from(source());
      ...
      it.each(someCases)('determines that a predicate checking for some value of $predicateExpected returns $expected after exhausting all iterable values', ({
        predicateExpected,
        expected,
      }) => {
        const reiterable = Reiterable.from(source());
      ...
      it.each(someCases)('determines that a predicate checking for some value of $predicateExpected returns $expected after exhausting as an iterator', ({
        predicateExpected,
        expected,
      }) => {
        const reiterable = Reiterable.from(source());
      ...
      it.each(someCases)('determines that a predicate checking for some value of $predicateExpected returns $expected after accessing the first item', ({
        predicateExpected,
        expected,
      }) => {
        const reiterable = Reiterable.from(source());
      ...
      it.each(someCases)('determines that a predicate checking for some value of $predicateExpected returns $expected after repeatedly accessing some or all of the items as iterables or an iterator', ({
        predicateExpected,
        expected,
      }) => {
        const reiterable = Reiterable.from(source());
