...
export const mathAlias = (method: MathAliasMethodName) => new NumberFunction(
  [{ arityType: 'required' }],
...
type Math2AliasMethodName =
  | 'atan2'
  | 'pow'
  ;

export const math2Alias = (method: Math2AliasMethodName) => new NumberFunction(
  [
    { arityType: 'required' },
    { arityType: 'required' },
  ],
...
export const mathNAlias = (method: MathNAliasMethodName) => new NumberFunction(
  [
