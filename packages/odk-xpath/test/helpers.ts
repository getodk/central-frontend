...
globalThis.IMPLEMENTATION = typeof IMPLEMENTATION === 'string'
  ? IMPLEMENTATION
  : undefined;
globalThis.TZ = typeof TZ === 'string'
  ? TZ
  : undefined;
...
interface EvaluationAssertionOptions {
  readonly contextNode?: Node | Nullish;
  readonly namespaceResolver?: XPathNSResolver | Nullish;
...
export class TestContext {
  ...
  readonly evaluator: XPathEvaluator;
  ...
  evaluate(
    expression: string,
    contextNode?: Node | Nullish,
    resultType?: XPathResultType | Nullish,
    namespaceResolver?: XPathNSResolver | Nullish
  ): XPathResult {
