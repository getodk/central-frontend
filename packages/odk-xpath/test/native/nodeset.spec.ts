...
describe('native nodeset functions', () => {
  ...
  describe('position()', () => {
    ...
    [
      { expression: "*[position()=-1]", expected: "" },
    ].forEach(({ expression, expected }) => {
      it(`should evaluate ${expression} as ${expected}`, () => {
  ...
  const localNameInput = [
    ...
    { expression: "local-name(self::node())", id: 'testFunctionNodesetElementNested', expected: "div" }, // element nested
    ...
    { expression: "local-name(attribute::node())", id: 'testFunctionNodesetAttribute', expected: 'id' }, // attribute
    { expression: `local-name(attribute::node()[2])`, id: 'testFunctionNodesetAttribute', expected: 'class' }, // attribute
    { expression: 'local-name()', parentId: 'testFunctionNodesetProcessingInstruction', expected: 'xml-stylesheet' }, // processing instruction
  ...
  localNameInput.forEach(({ expression, id, parentId, expected }) => {
    ...
    it(`${expression} ${contextLabel}`, () => {
      ...
      const { stringValue } = testContext.evaluate(expression, contextNode, XPathResult.STRING_TYPE);
  ...
  const namespaceURIInput = [
    ...
    { expression: "namespace-uri(self::node())", id: 'testFunctionNodesetElement', expected: "http://www.w3.org/1999/xhtml" }, // element
    { expression: "namespace-uri()", id: 'testFunctionNodesetElement', expected: "http://www.w3.org/1999/xhtml" }, // element
    { expression: "namespace-uri(node())", id: 'testFunctionNodesetElementNested', expected: "http://www.w3.org/1999/xhtml" }, // element nested
    { expression: "namespace-uri(self::node())", id: 'testFunctionNodesetElementNested', expected: "http://www.w3.org/1999/xhtml" }, // element nested
    { expression: "namespace-uri()", parentId: 'testFunctionNodesetElementPrefix', expected: "http://some-namespace.com/nss" }, // element
    ...
    { expression: "namespace-uri(attribute::node())", id: 'testFunctionNodesetAttribute', expected: '' }, // attribute
    { expression: `namespace-uri(attribute::node()[2])`, id: 'testFunctionNodesetAttribute', expected: 'http://some-namespace.com/nss' }, // attribute
    { expression: "namespace-uri(namespace::node())", id: 'testFunctionNodesetNamespace', expected: "" }, // namespace
    { expression: "namespace-uri(namespace::node()[2])", id: 'testFunctionNodesetNamespace', expected: "" }, // namespace
    { expression: 'namespace-uri()', parentId: 'testFunctionNodesetProcessingInstruction', expected: '' }, // processing instruction
  ...
  const nameInput = [
    ...
    { expression: `name(attribute::node()[2])`, id: 'testFunctionNodesetAttribute', expected: 'ev:class' }, // attribute
    { expression: "name(namespace::node())", id: 'testFunctionNodesetNamespace', expected: "" }, // namespace
    { expression: "name()", parentId: 'testFunctionNodesetProcessingInstruction', expected: 'xml-stylesheet' }, // Processing Instruction
