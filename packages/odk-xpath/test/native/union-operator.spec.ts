...
describe('Union operator', () => {
  ...
  describe('general tests', () => {
    ...
    it('returns all attributes', () => {
      testContext.assertNodeSet("id('eee40')/attribute::*", getNonNamespaceAttributes(document.getElementById('eee40')!));
    });
  ...
  it('combines different attributes on the same element', () => {
    ...
    testContext.assertUnorderedNodeSet("id('eee40')/attribute::*[2] | id('eee40')/attribute::*[1]",
      getNonNamespaceAttributes(document.getElementById('eee40')!)); //firefox
    // expected
    // [class="sss", id="eee40"]
  ...
  it('combines two namespaces on the same element', () => {
    ...
    testContext.assertNodeSet("id('nss40')/namespace::* | id('nss40')/namespace::*",
      result
    );
  });
  ...
  it('combines a namespace and attribute', () => {
    ...
    testContext.assertUnorderedNodeSet("id('nss40')/namespace::* | id('nss25')/attribute::* | id('nss25')", [
