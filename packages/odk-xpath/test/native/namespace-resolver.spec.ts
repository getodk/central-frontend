...
describe('namespace resolver', () => {
  ...
  it('looks up the namespaceURIDocumentElement', () => {
    let contextNode = document.documentElement;
    ...
    contextNode.setAttributeNS('http://www.w3.org/2000/xmlns/', 'xmlns', 'http://www.w3.org/1999/xhtml');
  ...
  it('looks up namespaceURIs that have changed', () => {
    ...
    // Back to original
    contextNode.setAttributeNS('http://www.w3.org/2000/xmlns/', 'xmlns', 'http://www.w3.org/TR/REC-html40');
  ...
  it('looks up a hierarchical namespaceURI', () => {
    ...
    resolver = document.createNSResolver(
      contextNode?.firstElementChild!.firstElementChild!
   );
    expect(resolver.lookupNamespaceURI('')).to.equal('http://www.w3.org/TR/REC-html40');
  });
});
