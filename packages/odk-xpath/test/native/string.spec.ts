...
describe('native string functions', () => {
  ...
  describe('string() conversion of nodesets', () => {
    ...
    const input = [
      ...
      { expression: "string(self::node())", id: 'FunctionStringCaseStringNodesetElement', expected: "aaa" }, // element
      { expression: "string()", id: 'FunctionStringCaseStringNodesetElement', expected: "aaa" }, // element
      { expression: "string(node())", id: 'FunctionStringCaseStringNodesetElementNested', expected: "bbb" }, // element nested
      { expression: "string(self::node())", id: 'FunctionStringCaseStringNodesetElementNested', expected: "bbbssscccddd" }, // element nested
      { expression: "string()", id: 'FunctionStringCaseStringNodesetElementNested', expected: "bbbssscccddd" }, // element nested
      { expression: "string()", parentId: 'FunctionStringCaseStringNodesetComment', expected: " hello world " }, // comment
      { expression: "string()", parentId: 'FunctionStringCaseStringNodesetText', expected: "here is some text" }, // text
      { expression: "string(attribute::node()[1])", id: 'FunctionStringCaseStringNodesetAttribute', expected: 'FunctionStringCaseStringNodesetAttribute' }, // attribute
      { expression: "string(attribute::node()[3])", id: 'FunctionStringCaseStringNodesetAttribute', expected: '  1   00%  ' }, // attribute
      { expression: 'string()', parentId: 'FunctionStringCaseStringNodesetProcessingInstruction', expected: 'type="text/xml" href="test.xsl"' }, // processing instruction
      { expression: 'string()', parentId: 'FunctionStringCaseStringNodesetCData', expected: 'some cdata' }, // CDataSection
   ];
  ...
  it('string conversion of nodeset with namespace', () => {
    ...
    const contextNode = testContext.document.getElementById('FunctionStringCaseStringNodesetNamespace');
  ...
  [
    { expression: "substring-before()" },
    { expression: "substring-before(1)" },
  ].forEach(({ expression }) => {
  ...
  describe('normalize-space()', () => {
    ...
    [
      ...
      { expression: "normalize-space('\na  \f \r\v  b\r\n  ')", expected: 'a \f \v b' },
      { expression: "normalize-space()", id: 'FunctionStringCaseStringNormalizeSpace1', expected: '' },
      { expression: "normalize-space()", id: 'FunctionStringCaseStringNormalizeSpace2', expected: '' },
      { expression: "normalize-space()", id: 'FunctionStringCaseStringNormalizeSpace3', expected: 'a b' },
      { expression: "normalize-space()", id: 'FunctionStringCaseStringNormalizeSpace4', expected: 'a bc c' },
    ].forEach(({ expression, id, expected }) => {
      it(`should evaluate ${expression} to ${expected}`, () => {
        const contextNode = id == null
          ? testContext.document
