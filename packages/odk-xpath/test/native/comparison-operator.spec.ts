...
describe('Comparison operator', () => {
  ...
  equalityCases.forEach(({ lhs, rhs, id, expected }) => {
    ...
    cases.forEach(({ expression, expected }) => {
      it(`evaluates ${expression} to ${expected}${contextSuffix}`, () => {
        const contextNode = id == null
          ? testContext.document
          : testContext.document.getElementById(id);
  ...
  describe('with nodes', () => {
    ...
    const equalityCases: readonly EqualityCase[] = [
      ...
      { lhs: "-10", rhs: "*", id: 'ComparisonOperatorCaseNodesetNegative5to5', expected: [false, true] },
      { lhs: "4", rhs: "*", id: 'ComparisonOperatorCaseNodesetNegative5to5', expected: [true, true] },
      { lhs: "4.3", rhs: "*", id: 'ComparisonOperatorCaseNodesetNegative5to5', expected: [false, true] },
      ...
      { lhs: "'aaa'", rhs: "*", id: 'ComparisonOperatorCaseNodesetStrings', expected: [true, true] },
      { lhs: "'bb'", rhs: "*", id: 'ComparisonOperatorCaseNodesetStrings', expected: [false, true] },
    ...
    const relativeCases: readonly RelativeCase[] = [
      ...
      { lhs: "-10", rhs: "*", id: 'ComparisonOperatorCaseNodesetNegative5to5', expected: [true, true, false, false] },
      { lhs: "10", rhs: "*", id: 'ComparisonOperatorCaseNodesetNegative5to5', expected: [false, false, true, true] },
      { lhs: "5", rhs: "*", id: 'ComparisonOperatorCaseNodesetNegative5to5', expected: [false, true, true, true] },
      { lhs: "2", rhs: "*", id: 'ComparisonOperatorCaseNodesetNegative5to5', expected: [true, true, true, true] },
      { lhs: "true()", rhs: "*", id: 'ComparisonOperatorCaseNodesetNegative5to5', expected: [true, true, true, true] },
      { lhs: "false()", rhs: "*", id: 'ComparisonOperatorCaseNodesetNegative5to5', expected: [true, true, true, true] },
      { lhs: "'4'", rhs: "*", id: 'ComparisonOperatorCaseNodesetNegative5to5', expected: [true, true, true, true] },
      { lhs: "*", rhs: "-10", id: 'ComparisonOperatorCaseNodesetNegative5to5', expected: [false, false, true, true] },
      { lhs: "*", rhs: "10", id: 'ComparisonOperatorCaseNodesetNegative5to5', expected: [true, true, false, false] },
      { lhs: "*", rhs: "5", id: 'ComparisonOperatorCaseNodesetNegative5to5', expected: [true, true, false, true] },
      { lhs: "*", rhs: "2", id: 'ComparisonOperatorCaseNodesetNegative5to5', expected: [true, true, true, true] },
      { lhs: "*", rhs: "true()", id: 'ComparisonOperatorCaseNodesetNegative5to5', expected: [true, true, true, true] },
      { lhs: "*", rhs: "false()", id: 'ComparisonOperatorCaseNodesetNegative5to5', expected: [true, true, true, true] },
      { lhs: "*", rhs: "'4'", id: 'ComparisonOperatorCaseNodesetNegative5to5', expected: [true, true, true, true] },

      { lhs: "*", rhs: "'aaa'", id: 'ComparisonOperatorCaseNodesetStrings', expected: [false, false, false, false] },
      { lhs: "'aaa'", rhs: "*", id: 'ComparisonOperatorCaseNodesetStrings', expected: [false, false, false, false] },

      { lhs: "0", rhs: "*", id: 'ComparisonOperatorCaseNodesetEmpty', expected: [false, false, false, false] },
      { lhs: "true()", rhs: "*", id: 'ComparisonOperatorCaseNodesetEmpty', expected: [false, false, false, false] },
      { lhs: "false()", rhs: "*", id: 'ComparisonOperatorCaseNodesetEmpty', expected: [false, false, false, false] },
      { lhs: "''", rhs: "*", id: 'ComparisonOperatorCaseNodesetEmpty', expected: [false, false, false, false] },
      { lhs: "*", rhs: "0", id: 'ComparisonOperatorCaseNodesetEmpty', expected: [false, false, false, false] },
      { lhs: "*", rhs: "true()", id: 'ComparisonOperatorCaseNodesetEmpty', expected: [false, false, false, false] },
      { lhs: "*", rhs: "false()", id: 'ComparisonOperatorCaseNodesetEmpty', expected: [false, false, false, false] },
      { lhs: "*", rhs: "''", id: 'ComparisonOperatorCaseNodesetEmpty', expected: [false, false, false, false] },
    ];
