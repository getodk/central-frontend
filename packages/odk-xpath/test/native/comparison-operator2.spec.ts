...
describe('Comparison operator (2)', () => {
  ...
  const input: readonly TestCaseInput[] = [
    ...
    { operands: [ "-10", "*" ], id: 'ComparisonOperatorCaseNodesetNegative5to5', expected: [ false, true ] },
    { operands: [ "4", "*" ], id: 'ComparisonOperatorCaseNodesetNegative5to5', expected: [ true, true ] },
    { operands: [ "4.3", "*" ], id: 'ComparisonOperatorCaseNodesetNegative5to5', expected: [ false, true ] },
    ...
    { operands: [ "true()", "*" ], id: 'ComparisonOperatorCaseNodesetNegative5to5', expected: [ true, false ] },
    { operands: [ "false()", "*" ], id: 'ComparisonOperatorCaseNodesetNegative5to5', expected: [ false, true ] },
    { operands: [ "true()", "*" ], id: 'ComparisonOperatorCaseNodesetEmpty', expected: [ false, true ] },
    { operands: [ "false()", "*" ], id: 'ComparisonOperatorCaseNodesetEmpty', expected: [ true, false ] },
    { operands: [ "'1a'", "'1a'" ], expected: [ true, false ] },
    { operands: [ "'1'", "'0'" ], expected: [ false, true ] },
    { operands: [ "''", "''" ], expected: [ true, false ] },
    { operands: [ "''", "'0'" ], expected: [ false, true ] },
    { operands: [ "'aaa'", "*" ], id: 'ComparisonOperatorCaseNodesetStrings', expected: [ true, true ] },
    { operands: [ "'bb'", "*" ], id: 'ComparisonOperatorCaseNodesetStrings', expected: [ false, true ] },
  ...
  describe('with nodes', () => {
    ...
    const input: readonly TestCaseInput[] = [
      { operands: [ "true()", "*" ], expected: [ true, true, true, true ], id: 'ComparisonOperatorCaseNodesetNegative5to5' },
      { operands: [ "false()", "*" ], expected: [ true, true, true, true ], id: 'ComparisonOperatorCaseNodesetNegative5to5' },
      { operands: [ "*", "true()" ], expected: [ true, true, true, true ], id: 'ComparisonOperatorCaseNodesetNegative5to5' },
      { operands: [ "*", "false()" ], expected: [ true, true, true, true ], id: 'ComparisonOperatorCaseNodesetNegative5to5' },
      { operands: [ "0", "*" ], expected: [ false, false, false, false ], id: 'ComparisonOperatorCaseNodesetEmpty' },
      { operands: [ "*", "0" ], expected: [ false, false, false, false ], id: 'ComparisonOperatorCaseNodesetEmpty' },
      { operands: [ "true()", "*" ], expected: [ false, false, false, false ], id: 'ComparisonOperatorCaseNodesetEmpty' },
      { operands: [ "false()", "*" ], expected: [ false, false, false, false ], id: 'ComparisonOperatorCaseNodesetEmpty' },
      { operands: [ "*", "true()" ], expected: [ false, false, false, false ], id: 'ComparisonOperatorCaseNodesetEmpty' },
      { operands: [ "*", "false()" ], expected: [ false, false, false, false ], id: 'ComparisonOperatorCaseNodesetEmpty' },
      { operands: [ "-10", "*" ], expected: [ true, true, false, false ], id: 'ComparisonOperatorCaseNodesetNegative5to5' },
      { operands: [ "10", "*" ], expected: [ false, false, true, true ], id: 'ComparisonOperatorCaseNodesetNegative5to5' },
      { operands: [ "5", "*" ], expected: [ false, true, true, true ], id: 'ComparisonOperatorCaseNodesetNegative5to5' },
      { operands: [ "2", "*" ], expected: [ true, true, true, true ], id: 'ComparisonOperatorCaseNodesetNegative5to5' },
      { operands: [ "'4'", "*" ], expected: [ true, true, true, true ], id: 'ComparisonOperatorCaseNodesetNegative5to5' },
      { operands: [ "'aaa'", "*" ], expected: [ false, false, false, false ], id: 'ComparisonOperatorCaseNodesetStrings' },
      { operands: [ "''", "*" ], expected: [ false, false, false, false ], id: 'ComparisonOperatorCaseNodesetEmpty' },
      { operands: [ "*", "-10" ], expected: [ false, false, true, true ], id: 'ComparisonOperatorCaseNodesetNegative5to5' },
      { operands: [ "*", "10" ], expected: [ true, true, false, false ], id: 'ComparisonOperatorCaseNodesetNegative5to5' },
      { operands: [ "*", "5" ], expected: [ true, true, false, true ], id: 'ComparisonOperatorCaseNodesetNegative5to5' },
      { operands: [ "*", "2" ], expected: [ true, true, true, true ], id: 'ComparisonOperatorCaseNodesetNegative5to5' },
      { operands: [ "*", "'4'" ], expected: [ true, true, true, true ], id: 'ComparisonOperatorCaseNodesetNegative5to5' },
      { operands: [ "*", "'aaa'" ], expected: [ false, false, false, false ], id: 'ComparisonOperatorCaseNodesetStrings' },
      { operands: [ "*", "''" ], expected: [ false, false, false, false ], id: 'ComparisonOperatorCaseNodesetEmpty' },
      { operands: [ "id('ComparisonOperatorCaseNodesetNegative5to5')/*", "id('ComparisonOperatorCaseNodesetEmpty')/*" ], expected: [ false, false, false, false ] },
      { operands: [ "id('ComparisonOperatorCaseNodesetNegative5to5')/*", "id('ComparisonOperatorCaseNodeset4to8')/*" ], expected: [ true, true, true, true ] },
      { operands: [ "id('ComparisonOperatorCaseNodesetNegative5to5')/*", "id('ComparisonOperatorCaseNodeset6to10')/*" ], expected: [ true, true, false, false ] },
    ];
