...
const isComment = (node: Node | null): node is Comment => (
...
const getTestProcessingInstruction = (
...
const getDescendantNodes = (node: Node): readonly Node[] => {
  return Array.from(node.childNodes).flatMap((childNode) => [childNode, ...getDescendantNodes(childNode)]);
};
...
describe('axis', () => {
  ...
  describe('parent axis', () => {
    ...
    it('works with an attribute context', () => {
      ...
      testContext.assertNodeSet("parent::node()", [document.getElementById('testStepAxisNodeAttribute')!], {
        contextNode,
      });
    });
    ...
    it('works with a comment context', () => {
      ...
      testContext.assertNodeSet("parent::node()", [
        getTestCommentParentElement(document),
      ], {
        contextNode,
      });
    });
    ...
    it('works with a processing instruction', () => {
      ...
      testContext.assertNodeSet("parent::node()", [getTestProcessingInstructionParentElement(document)], {
        contextNode,
      });
    });
  });
  ...
  describe('ancestor-or-self axis', () => {
    ...
    it('works for documentElement context', () => {
      ...
      testContext.assertNodeSet("ancestor-or-self::node()", [
          document,
          document.documentElement
      ], {
        contextNode,
  ...
  describe('following-sibling axis', () => {
    ...
    it('works for a documentElement context', () => {
      ...
      testContext.assertNodeSet("following-sibling::node()", getFollowingSiblings(document.documentElement), {
        contextNode,
      });
    });
  ...
  describe('preceding-sibling axis', () => {
    ...
    it('works for a documentElement context', () => {
      ...
      testContext.assertNodeSet("preceding-sibling::node()", getPrecedingSiblings(document.documentElement), {
        contextNode,
      });
    });
  ...
  describe('following axis', () => {
    ...
    it('works for a documentElement context', () => {
      ...
      testContext.assertNodeSet("following::node()", getFollowingNodes(document, document.documentElement), {
        contextNode,
      });
    });
    ...
    it('works for an attribute context', () => {
      ...
      testContext.assertNodeSet("following::node()", getFollowingNodes(document, document.getElementById('testStepAxisNodeAttribute')!), {
        contextNode,
      });
    });
  ...
  describe('preceding axis', () => {
    ...
    it('works for a documentElement context', () => {
      ...
      testContext.assertNodeSet("preceding::node()", getPrecedingNodes(document, document.documentElement), {
        contextNode,
      });
    });
    ...
    it('works for an attribute context', () => {
      ...
      testContext.assertNodeSet("preceding::node()", getPrecedingNodes(document, document.getElementById('testStepAxisNodeAttribute')!), {
        contextNode,
      });
    });
