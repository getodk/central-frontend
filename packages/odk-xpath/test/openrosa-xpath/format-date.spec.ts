...
describe('#format-date()', () => {
  ...
  [
    { expression: 'format-date(.,  "%Y/%n | %y/%m | %b" )', id: 'FunctionDateCase1', expected: '2012/7 | 12/07 | Jul' },
    { expression: 'format-date(., "%Y/%n | %y/%m | %b" )', id: 'FunctionDateCase2', expected: '2012/8 | 12/08 | Aug' },
    // TODO: this should fail according to spec!
    { expression: 'format-date(., "%M | %S | %3")', id: 'FunctionDateCase2', expected: '00 | 00 | 000' },
    { expression: `format-date('${date.toString()}', '%e | %a' )`, id: null,
        expected: `${date.getDate()} | ${['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'][date.getDay()]}` },
  ...
  [
    ...
    { expression: 'format-date("2017-05-26T01:00:00-07:00", "%a %b")', expected: 'Fri May', language: 'en' },
