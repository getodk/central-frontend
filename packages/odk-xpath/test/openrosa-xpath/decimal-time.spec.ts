...
describe('decimal-time()', () => {
  ...
  [
    { expression: 'decimal-time("06:00:00.000-07:00")', expected: 0.250 },
    { expression: 'decimal-time("06:00:00.000-01:00")', expected: 0.000 },
  ...
  it('should convert times provided with a node parameter', () => {
    ...
    testContext.assertNumberValue('decimal-time( /data/a )', 0.250);
  });

  it('facilitates time calculations and evaluates', () => {
    testContext.assertNumberValue('decimal-time("12:00:00.000-07:00") - decimal-time("06:00:00.000-07:00")', 0.250);
  });
