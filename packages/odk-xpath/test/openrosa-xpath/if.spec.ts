...
describe('#if()', () => {
  ...
  describe('with node evaluation', () => {
    ...
    it(`should evaluate an "and" expression that checks values of nodes (1)`, () => {
      ...
      testContext.assertStringValue('if(. != "0" and /div/div[@id="FunctionCheckListCaseEmpty"] != "", "yes", "no")', 'no', {
        contextNode,
      });
    });
    ...
    it(`should evaluate an "and" expression that checks values of nodes (3)`, () => {
      ...
      testContext.assertStringValue('if(. = "0" and /div/div[@id="FunctionChecklistCaseNo"] ="no", "yes", "no")', 'yes', {
        contextNode,
      });
    });
    ...
    it(`should evaluate an "or" expression that checks values of nodes (1)`, () => {
      ...
      testContext.assertStringValue('if(. != "0" or /div/div[@id="FunctionCheckListCaseEmpty"] != "", "yes", "no")', 'no', {
        contextNode,
      });
    });
    ...
    it(`should evaluate an "or" expression that checks values of nodes (2)`, () => {
      ...
      testContext.assertStringValue('if(. = "0" or /div/div[@id="FunctionCheckListCaseEmpty"] != "", "yes", "no")', 'yes', {
        contextNode,
      });
    });
    ...
    it(`should evaluate an "or" expression that checks values of nodes (3)`, () => {
      ...
      testContext.assertStringValue('if(. != "0" or /div/div[@id="FunctionChecklistCaseNo"] ="no", "yes", "no")', 'yes', {
        contextNode,
      });
    });
    ...
    it(`should evaluate true and false outcomes`, () => {
      ...
      testContext.assertStringValue('if(false(), "yes", concat(/div/div[@id="FunctionChecklistCaseNo"], "-no"))', 'no-no', {
        contextNode,
      });
    });
  });
  ...
  describe('should deal with nesting and lengthy or/and clauses (with booleans)', ()=> {
    [
      { expression: 'if( false() and true(), "A", if(false(), "B", "C") )',
          expected: 'C' },
      { expression: 'if( false() and explode-a(), "A", if(false() and explode-b(), "B", "C") )',
          expected: 'C' },
      { expression: 'if( false() and explode-a(), "A", if(false() and explode-b(), "B", true() or false()) )',
          expected: 'true' },
      { expression: 'if( false() and explode-a(), "A", if(false() and explode-b(), "B", false() or true()) )',
          expected: 'true' },
      { expression: 'if( false() and explode-a(), "A", if(false() and explode-b(), "B", false() and true()) )',
          expected: 'false' },
      { expression: 'if( false() and explode-a(), "A", if(false() and explode-b(), "B", true() and false()) )',
          expected: 'false' },
      { expression: 'if( false() and explode-a(), "A", if(false() and explode-b(), "B", false() and false()) )',
          expected: 'false' },
      { expression: 'if( false() and explode-a(), "A", if(false() and explode-b(), "B", true() and true()) )',
          expected: 'true' },
      { expression: 'if( false() and explode-a(), "A", if(true() or explode-b(), false() and explode-c(), true() or explode-d()) )',
          expected: 'false' },
      { expression: 'if( true() or true() and false(), "A", if(true() or true() and false(), true() or true() and false(), "B") )',
          expected: 'A' },
      { expression: 'if( true() or true() and false(), "A", if(true() or true() and false(), true() or true() and false(), true() or true() and explode-d()) )',
          expected: 'A' },
      { expression: 'if( true() or true() and false(), "A", if(true() or true() and false(), true() or true() and explode-c(), true() or true() and explode-d()) )',
          expected: 'A' },
      { expression: 'if( true() or true() and false(), "A", if(true() or true() and explode-b(), true() or true() and explode-c(), true() or true() and explode-d()) )',
          expected: 'A' },
      { expression: 'if( true() or true() and explode-a(), "A", if(true() or true() and explode-b(), true() or true() and explode-c(), true() or true() and explode-d()) )',
          expected: 'A' },
  ...
  describe('deviation from the XForms spec', () => {
    ...
    describe('it should NOT coerce the result to a string', () => {
      [
        ...
        { expression: 'if(false(), true(), false())', expected: { string: 'false', boolean: false } },
      ].forEach(({ expression, expected }) => {
      ...
      [
        { expression: 'count( if(true(), //b, //a ))', expected: 2 },
      ].forEach(({ expression, expected }) => {
