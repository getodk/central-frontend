...
describe('#date()', () => {
  ...
  describe('valid date string', () => {
    ...
    describe('dates as string', () => {
      ...
      it('example 6', () => {
        testContext.assertStringValue('date(decimal-date-time("2003-10-20T08:00:00.000-07:00"))', '2003-10-20T08:00:00.000-07:00');
      });
  ...
  it('should convert now() to a date string with time component', () => {
    testContext.assertStringMatches('now()', /([0-9]{4}-[0-9]{2}-[0-9]{2})([T]|[\s])([0-9]){2}:([0-9]){2}([0-9:.]*)(\+|-)([0-9]{2}):([0-9]{2})$/);
  });
  ...
  describe('datestring comparisons (date detection)', () => {
    ...
    [
      ...
      { expression: "../node()[@id='FunctionDateCase2'] > ../node()[@id='FunctionDateCase3']", id: 'FunctionDateCase1', expected: true },
  ...
  describe('date calculations', () => {
    ...
    [
      ...
      { expression: ". = 30 + /xhtml:html/xhtml:body/xhtml:div[@id='FunctionDate']/xhtml:div[@id='FunctionDateCase4']", id: 'FunctionDateCase1', expected: true },
    ...
    [
      { expression: '10 + date("2012-07-24")', expected: 15555.29 },
    ].forEach(({ expression, expected }) => {
      it(`should convert ${expression} to ${expected}`, () => {
        testContext.assertNumberRounded(expression, expected, 100);
