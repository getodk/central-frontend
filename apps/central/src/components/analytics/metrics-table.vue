    ...
    <tbody>
      <tr v-for="(value, name) in metrics" :key="name">
        ...
        <template v-else-if="value.recent != null">
          <td class="metric-value">{{ $nnnnnnnnnn(value.recent) }}</td>
          <td class="metric-value">{{ $nnnnnnnnnn(value.total) }}</td>
        </template>
        <template v-else>
          <td colspan="2" class="metric-value">{{ $nnnnnnnnnn(value) }}</td>
        </template>
      </tr>
    </tbody>
  </table>
...
<i18n lang="json5">
{
  "en": {
    ...
    "fields": {
      ...
      "num_datasets_deleted": "Number of Entity List delete events",
      "num_dataset_properties_deleted": "Number of Entity property delete events",
      "num_owner_only_datasets_per_project": "Number of Entity Lists restricted to Owner Only",
      "num_custom_user_properties": "Number of custom User Properties",
      "num_user_property_filtered_datasets": "Number of Entity Lists restricted by User Properties",
      ...
      "login_customization_logo_set": "Custom login page logo set",
      "login_customization_hero_image_set": "Custom login page hero image set",
      "login_customization_title_set": "Custom login page title set",
      "login_customization_description_set": "Custom login page description set",
...
<i18n>
{
  ...
  "de": {
    ...
    "fields": {
      ...
      "login_customization_logo_set": "Set mit benutzerdefinierten Logos für die Anmeldeseite",
      "login_customization_hero_image_set": "Set mit benutzerdefinierten Hero-Bildern für die Anmeldeseite",
      "login_customization_title_set": "Benutzerdefinierter Titel für die Anmeldeseite festgelegt",
      "login_customization_description_set": "Beschreibung der benutzerdefinierten Anmeldeseite festgelegt",
  ...
  "es": {
    ...
    "fields": {
      ...
      "login_customization_logo_set": "Conjunto de logotipos personalizados para la página de inicio de sesión",
      "login_customization_hero_image_set": "Conjunto de imágenes de cabecera para la página de inicio de sesión personalizada",
      "login_customization_title_set": "Conjunto de títulos personalizados para la página de inicio de sesión",
      "login_customization_description_set": "Conjunto de descripciones personalizadas para la página de inicio de sesión",
  ...
  "fr": {
    ...
    "fields": {
      ...
      "num_datasets_deleted": "Nombre d'événements de suppression de listes d'entités",
      "num_dataset_properties_deleted": "Nombre d'événements de propriétés supprimées",
      "num_owner_only_datasets_per_project": "Nombre de listes d'entités restreintes au propriétaire",
      "num_custom_user_properties": "Nombre de propriétés personalisées",
      "num_user_property_filtered_datasets": "Nombre de listes d'entités filtrées par propriété",
      ...
      "login_customization_logo_set": "Logo personnalisé sur la page de connexion",
      "login_customization_hero_image_set": "Image personnalisée sur la page de connexion",
      "login_customization_title_set": "Titre personnalisé sur la page de connexion",
      "login_customization_description_set": "Description personnalisée sur la page de connexion",
  ...
  "it": {
    ...
    "fields": {
      ...
      "num_datasets_deleted": "Numero di eventi di eliminazione dall'elenco delle entità",
      "num_dataset_properties_deleted": "Numero di eventi di eliminazione della proprietà dell'entità",
      ...
      "login_customization_logo_set": "Set di loghi personalizzati per la pagina di accesso",
      "login_customization_hero_image_set": "Set di immagini di copertina personalizzate per la pagina di accesso",
      "login_customization_title_set": "Titolo della pagina di accesso personalizzato",
      "login_customization_description_set": "Impostazione della descrizione della pagina di accesso personalizzata",
  ...
  "pt": {
    ...
    "fields": {
      ...
      "max_geo_per_form": "Número máximo de Respostas com dados espaciais em um Formulários",
      "num_datasets_with_geometry": "Número de Listas de Entidades com a propriedade geometria",
      "num_entity_create_forms": "Número de Formulários que criam Entidades",
      "num_repeat_entity_create_forms": "Número de Formulários que criam Entidades em repetições",
      "num_entity_update_forms": "Número de Formulários que atualizam Entidades",
      "num_repeat_entity_update_forms": "Número de Formulários que atualizam Entidades em repetições",
      "num_entity_create_update_forms": "Número de Formulários que criam e também atualizam Entidades",
      "num_entities_with_geometry": "Número de Entidades com dados de geometria",
      "num_multi_entity_errors": "Número de erros vindos de Entidades em repetições"
    }
  },
  "sw": {
  ...
  "zh": {
    ...
    "fields": {
      ...
      "num_datasets_deleted": "实体列表删除事件数量",
      "num_dataset_properties_deleted": "实体属性删除事件数量",
      "num_properties": "属性数量",
      ...
      "login_customization_logo_set": "自定义登录页面标志设置",
      "login_customization_hero_image_set": "自定义登录页面主视觉图片已设置",
      "login_customization_title_set": "自定义登录页面标题已设置",
      "login_customization_description_set": "自定义登录页面描述已设置",
