...
<i18n>
{
  ...
  "fr": {
    ...
    "fields": {
      ...
      "num_owner_only_datasets_per_project": "Nombre de listes d'entités avec accès du propriétaire seulement",
      "num_custom_user_properties": "Nombre de propriétés personalisées",
      "num_user_property_filtered_datasets": "Nombre de listes d'entités filtrées par des propriétés d'usagers",
