...
{
  "fr": {
    "title": "Ajouter propriété personnalisée",
    "introduction": "Pour ajouter une propriété personnalisée à ce projet, choisissez un nom de propriété unique ci-dessous.",
