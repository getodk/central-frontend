...
<i18n>
{
  ...
  "de": {
    "placeholder": "Neuer Eigenschaftsname"
  },
  "es": {
    "placeholder": "Nuevo nombre de propiedad"
  },
  "fr": {
    "invalidName": "Le nom de la propriété est invalide",
    "duplicate": {
      "title": "Une propriété avec ce nom existe déjà",
      "description": "Les noms de propriétés doivent être uniques, quelle que soit la casse."
    },
    "tryDifferent": "Essayez un autre nom.",
    "placeholder": "Nom de la nouvelle propriété"
  },
  "it": {
    "tryDifferent": "Prova un nome diverso",
    "placeholder": "Nuovo nome della proprietà"
  },
  "pt": {
