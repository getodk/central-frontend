...
{
  "de": {
    "displayNameLabel": "App-Benutzer"
  },
  "es": {
    "displayNameLabel": "Usuario móvil"
  },
  "fr": {
    "title": "Modifier l'utilisateur mobile «{displayName}»",
    "displayNameLabel": "Utilisateur mobile"
  },
  "it": {
    "displayNameLabel": "Utente dell'applicazione"
  }
}
</i18n>
