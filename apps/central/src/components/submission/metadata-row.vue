...
<template>
  <tr class="submission-metadata-row">
    <td class="row-number">{{ $nnnnnnnnnn('submission.metadataRow.rowNumber', rowNumber, 'noGrouping') }}</td>
      ...
      <div class="col-content">
        ...
        <span class="edits">
          <template v-if="submission.__system.edits !== 0">
            ...
            <span>{{ $nnnnnnnnnn('submission.metadataRow.__sytemt=edits', submission.__system.edits, 'default') }}</span>
          </template>
        </span>
