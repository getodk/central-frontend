...
describe('ActorPropertiesNew', () => {
  ...
  it('adds the new property to actorProperties.data after a successful POST', () => {
    return mockHttp()
      .mount(ActorPropertiesNew, mergeMountOptions({}, {
        container: {
          requestData: testRequestData(['actorProperties'], {
  ...
  it('shows an alert on a 409.3 duplicate name conflict', () => {
    return mockHttp()
      .mount(ActorPropertiesNew, mergeMountOptions({}, {
        container: {
          requestData: testRequestData(['actorProperties'], {
  ...
  it('disables the Add and Cancel buttons while the request is in flight', () => {
    return mockHttp()
      .mount(ActorPropertiesNew, mergeMountOptions({}, {
        container: {
          requestData: testRequestData(['actorProperties'], {
