...
describe('SubmissionReviewState', () => {
  it('renders correctly for null', () => {
    ...
    component.classes('tag-info').should.be.true;
  ...
  it('renders correctly for hasIssues', () => {
    ...
    component.classes('tag-warning').should.be.true;
  ...
  it('renders correctly for edited', () => {
    ...
    component.classes('tag-default').should.be.true;
  ...
  it('renders correctly for approved', () => {
    ...
    component.classes('tag-success').should.be.true;
  ...
  it('renders correctly for rejected', () => {
    ...
    component.classes('tag-danger').should.be.true;
