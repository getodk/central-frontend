...
- Install docker or NGINX.
  - The `npm run dev` runs NGINX in a Docker. If you'd rather skip that, install NGINX directly and use `npm run dev-no-docker` instead.
