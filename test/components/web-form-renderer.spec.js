...
import simpleXml, { submission as simpleSubmission } from '../data/simple';
// import { submission as simpleSubmission } from '../data/simple';
...
describe('WebFormRenderer', () => {
  ...
  beforeAll(async () => {
    // import this at the top causes this file to be skipped by karma/mocha
