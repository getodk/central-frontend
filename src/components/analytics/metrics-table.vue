...
<i18n lang="json5">
{
  "en": {
    ...
    "fields": {
      ...
      "uses_external_blob_store": "Server uses external blob store",
      "num_offline_entity_submissions_force_processed": "Number of force-processed Offline Entity submissions",
      "max_entity_branch_delay": "Maximum Offline Entity branch processing time",
      "num_xml_only_form_defs": "Number of XML-only Form Defs with no associated XLSForm",
      "num_blob_files": "Number of binary files",
      "num_blob_files_on_s3": "Number of binary files currently stored in external Blob store",
      "num_reset_failed_to_pending_count": "Number of times user has reset failed External Blob upload state",
      "num_entity_creates_sub": "Number of creates through Submissions",
      "num_entity_creates_api": "Number of creates through API",
      "num_entity_creates_bulk": "Number of creates through Bulk Upload",
    }
  }
}
</i18n>
