...
<i18n>
{
  ...
  "ja": {
    "title": "復号してダウンロード",
    "introduction": [
      "このデータをダウンロードするためには、パスフレーズを入力する必要があります。パスフレーズは、データをダウンロードする際の復号化にのみ使用され、その後、サーバーはパスフレーズを保持しません。"
    ],
    "hint": "ヒント：{hint}",
    "alert": {
      "submit": "データダウンロードはすぐに始まります。始まり次第、このボックスを閉じて構いません。いつまでも開始されない場合は、もう一度試して下さい。"
    }
  }
}
</i18n>
