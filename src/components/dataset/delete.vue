...
{
  "de": {
    "title": "Objektliste löschen",
    "introduction": [
      "Sind Sie sicher, dass Sie die Objektliste “{name}” löschen möchten? Das lässt sich nicht rückgängig machen"
    ]
  },
  "es": {
    "title": "Borrar lista de entidades",
    "introduction": [
