...
<i18n>
{
  ...
  "pt": {
    ...
    "steps": [
      ...
      {
        "title": "Carregar Anexos do Formulário",
        "body": [
          {
            "full": "O desenho do seu Formulário faz referência a arquivos que são necessários para apresentar seu Formulário. Você pode carregar cópias novas ou atualizadas deles para distribuição na aba {formAttachments}.",
  ...
  "zh-Hant": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "body": [
          {
            "status": "如果您對表單本身進行了更改，包括問題文字或邏輯規則，現在是時候使用右側的按鈕上傳新的 XML 或 XLSForm 了。",
            "link": {
              "full": "如果您對表單本身進行了更改，包括問題文字或邏輯規則，現在是時候{upload}新的 XML 或 XLSForm 了。",
              "upload": "上傳"
            }
          }
        ]
      },
      {
        ...
        "body": [
          {
            "full": "您的表單設計引用了展示表單所需的文件。您可以在 {formAttachments} 標籤內，上傳這些檔案的新副本或更新副本以進行部署。",
      ...
      },
      {
        ...
        "body": [
          {
            "full": "您可以{test}表單以確保它按您期望的方式運作。測試提交不包含在您的最終資料中。",
            "test": "測試"
          }
        ]
      },
      {
        ...
        "body": [
          {
            "status": "當您確定草稿已準備好並且希望將其發布到現場設備時，您可以使用右側的按鈕發布它。",
            "link": {
              "full": "當您確定草稿已準備好並且希望將其部署到現場設備上時，您可以{publish}它。",
              "publish": "發布"
            }
          }
        ]
