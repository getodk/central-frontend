...
<i18n>
{
  ...
  "ja": {
    ...
    "introduction": {
      "abandon": [
        "このフォームの下書きバージョンを永久に削除しようとしています。これは、下書きの定義フォームおよびアップロードした下書きバージョンのメディアファイル、テスト送信された全てのサブミッションが削除されることを意味します。",
        "あなたの公開した定義フォームやメディアファイル、サブミッションは影響を受けません"
      ],
      "deleteForm": [
        "この定義フォームの下書きおよび下書きのメディアファイル、テスト送信された全てのサブミッションは永久に削除されます。なぜなら、まだこのフォームを公開していないので、完全に削除されます。"
      ]
    },
    "action": {
      "abandon": "削除"
