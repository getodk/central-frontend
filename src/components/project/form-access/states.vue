...
<i18n>
{
  ...
  "ja": {
    "title": "フォームの状態",
    "introduction": [
      "「フォームの状態」では、各フォームのライフサイクルにおける状態を制御します。例外もありますが、通常、フォームは「公開」から始まり、「クロージング状態」を経て、不要になったら「終了」となります。",
      {
        "full": "{open}のフォームはモバイルデバイスにダウンロードでき、新しいサブミッションも受け付けます。",
        "open": "公開中"
      },
      {
        "full": "{closing}のフォームは新しいサブミッションを受け付けますが、モバイルデバイスにダウンロードはでき{not}。",
        "closing": "クロージング状態",
        "not": "ません"
      },
      {
        "full": "{closed}フォームはモバイルデバイスにダウンロードでき{not1}。また新しいサブミッションも受け付け{not2}。",
        "closed": "終了",
        "not1": "ません",
        "not2": "ません"
      }
