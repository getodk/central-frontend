...
module.exports = (config) => {
  config.set({
    ...
    proxies: {
      ...
      // Images
      '/img/banner@2x.69010702.png': '/base/src/assets/images/whats-new/banner@2x.png', // Image in what's new modal with hash
      '/img/banner@1x.f9c0533e.png': '/base/src/assets/images/whats-new/banner@1x.png', // Smaller resolution for circleCI test
