...
/*
A component that is the parent of an Alert component must define a property in
data() named 'alert', containing the alert's underlying data. The property must
be an object that has the following properties:

  - state. true if the alert is visible and false if not.
  - type. The alert's "contextual" type: 'success', 'info', 'warning', or
    'danger'.
  - message. The message to display.
  - at. The time at which the data object was created.
*/
...
// Convenience class used to make it easier to modify a component's alert
