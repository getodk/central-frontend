...
The following meta fields are supported:
  ...
  - preserveData (optional). By default, whenever the route changes, data is
    cleared for all request keys. preserveData specifies exceptions to that rule.
    ...
    Do not set this field directly: use preserveDataForKey() instead.
*/
const routes = [
  {
    path: '/login',
